...
//Note from Brandon, this code was sourced and improved on based on 
//https://github.com/azmenak/material-ui-nested-menu-item/issues/29, 
//which is an outdated component designed for mui 4.9, but has been manually updated to latest
//dependencies
