...
} from '../../../store/thunks/configuration';

import './Configuration.scss';
import { selectFactoryRESTResponseTableValues } from '../../../store/common/REST/selectors';
import { selectConfigurationStore } from '../../../store/ConfigurationStore/selectors';
...
const ConfigurationTable = ({ history }) => {
  const dispatch = useDispatch();

  const { configuration, workflows } = useSelector(
    state => ({
      configuration: selectFactoryRESTResponseTableValues(selectConfigurationStore)(state),
