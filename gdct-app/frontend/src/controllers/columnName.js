...
const columnNameController = (() => {
  ...
  return {
    ...
    fetchAttribute: async _id => columnNameAxios.post('/fetchAttribute', { _id }).then(res => res.data),
    create: async columnName => columnNameAxios.post('/create', { columnName }).then(res => res.data.columnName),
