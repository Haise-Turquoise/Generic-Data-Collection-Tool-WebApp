...
const AppRoleController = (() => {
  ...
  return {
    ...
    fetchAppRole: async (_id: string): Promise<AppRole | null> => AppRoleAxios.post('/fetchAppRole', { _id }).then(res => res.data),
    create: async (AppRole: AppRole): Promise<AppRole | null> =>
