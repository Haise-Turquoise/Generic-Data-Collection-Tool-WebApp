...
const COAGroupController = (() => {
  ...
  return {
    ...
    fetchCOAGroup: async (_id: string): Promise<CategoryGroup> => COAGroupAxios.post('/fetchCOAGroup', { _id }).then(res => res.data),
    create: async (COAGroup: CategoryGroup): Promise<CategoryGroup> =>
