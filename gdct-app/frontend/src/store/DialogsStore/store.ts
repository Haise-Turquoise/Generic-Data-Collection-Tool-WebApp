...
import { DialogsStore, state } from '../types';

const OPEN_ORGANIZATION_DIALOG = (state: DialogsStore) => ({
  ...state,
  isOrganizationDialogOpen: true,
});
const CLOSE_ORGANIZATION_DIALOG = (state: DialogsStore) => ({
  ...state,
  isOrganizationDialogOpen: false,
});

const OPEN_COA_GROUP_DIALOG = (state: DialogsStore) => ({
  ...state,
  isCOAGroupDialogOpen: true,
});
const CLOSE_COA_GROUP_DIALOG = (state: DialogsStore) => ({
  ...state,
  isCOAGroupDialogOpen: false,
});
const OPEN_COA_DIALOG = (state: DialogsStore) => ({ ...state, isCOADialogOpen: true });
const CLOSE_COA_DIALOG = (state: DialogsStore) => ({ ...state, isCOADialogOpen: false });

const CLOSE_USER_DIALOG = (state: DialogsStore) => ({ ...state, isUserDialogOpen: false });
...
const CLOSE_SUBMISSION_PERIOD_DIALOG = (state: DialogsStore) => ({
  ...state,
  isSubmissionPeriodDialogOpen: false,
});
const OPEN_TEMPLATE_TYPE_DIALOG = (state: DialogsStore) => ({
  ...state,
  isTemplateTypeDialogOpen: true,
});
const CLOSE_TEMPLATE_TYPE_DIALOG = (state: DialogsStore) => ({
  ...state,
  isTemplateTypeDialogOpen: false,
});
const OPEN_REPORTING_PERIOD_DIALOG = (state: DialogsStore) => ({
  ...state,
  isReportingPeriodDialogOpen: true,
});
const CLOSE_REPORTING_PERIOD_DIALOG = (state: DialogsStore) => ({
  ...state,
  isReportingPeriodDialogOpen: false,
});

const OPEN_TEMPLATE_DIALOG = (state: DialogsStore) => ({
  ...state,
  isTemplateDialogOpen: true,
});
const CLOSE_TEMPLATE_DIALOG = (state: DialogsStore) => ({
  ...state,
  isTemplateDialogOpen: false,
});
const OPEN_WORKFLOW_DIALOG = (state: DialogsStore) => ({
  ...state,
  isWorkflowDialogOpen: true,
});
const CLOSE_WORKFLOW_DIALOG = (state: DialogsStore) => ({
  ...state,
